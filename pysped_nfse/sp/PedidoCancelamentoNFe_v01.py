...
#
# Generated Fri Dec 28 16:00:25 2012 by generateDS.py version 2.7b.
#
...
class PedidoCancelamentoNFe(GeneratedsSuper):
    """Schema utilizado para PEDIDO de Cancelamento de NF-e.Este Schema XML
    é utilizado pelos Prestadores de serviços cancelarem NF-e
    emitidas por eles."""
    subclass = None
    superclass = None
    def __init__(self, Cabecalho=None, Detalhe=None, Signature=None):
    ...
    def get_Detalhe(self): return self.Detalhe
    def set_Detalhe(self, Detalhe): self.Detalhe = Detalhe
    def add_Detalhe(self, value): self.Detalhe.append(value)
    def insert_Detalhe(self, index, value): self.Detalhe[index] = value
    def get_Signature(self): return self.Signature
    def set_Signature(self, Signature): self.Signature = Signature
    def export(self, outfile, level, namespace_='', name_='PedidoCancelamentoNFe', namespacedef_=''):
        showIndent(outfile, level)
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = []
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='PedidoCancelamentoNFe')
        if self.hasContent_():
            outfile.write('>\n')
            ...
            outfile.write('/>\n')
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='PedidoCancelamentoNFe'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='PedidoCancelamentoNFe', fromsubclass_=False):
        if self.Cabecalho is not None:
            self.Cabecalho.export(outfile, level, namespace_, name_='Cabecalho', )
        for Detalhe_ in self.Detalhe:
            Detalhe_.export(outfile, level, namespace_, name_='Detalhe')
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def exportLiteral(self, outfile, level, name_='PedidoCancelamentoNFe'):
        level += 1
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.Cabecalho is not None:
            ...
            outfile.write('),\n')
        showIndent(outfile, level)
        outfile.write('Detalhe=[\n')
        level += 1
        for Detalhe_ in self.Detalhe:
            showIndent(outfile, level)
            outfile.write('model_.DetalheType(\n')
            Detalhe_.exportLiteral(outfile, level, name_='DetalheType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class CabecalhoType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, Versao=None, CPFCNPJRemetente=None, transacao=True):
    ...
    def get_CPFCNPJRemetente(self): return self.CPFCNPJRemetente
    def set_CPFCNPJRemetente(self, CPFCNPJRemetente): self.CPFCNPJRemetente = CPFCNPJRemetente
    def get_transacao(self): return self.transacao
    def set_transacao(self, transacao): self.transacao = transacao
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='CabecalhoType', fromsubclass_=False):
        ...
        if self.transacao is not None:
            showIndent(outfile, level)
            outfile.write('<%stransacao>%s</%stransacao>\n' % (namespace_, self.gds_format_boolean(self.gds_str_lower(str(self.transacao)), input_name='transacao'), namespace_))
    def hasContent_(self):
        if (
            self.CPFCNPJRemetente is not None or
            self.transacao is not None
            ):
            return True
        else:
            return False
...
class DetalheType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, ChaveNFe=None, AssinaturaCancelamento=None):
        self.ChaveNFe = ChaveNFe
    ...
    def get_ChaveNFe(self): return self.ChaveNFe
    def set_ChaveNFe(self, ChaveNFe): self.ChaveNFe = ChaveNFe
    def get_AssinaturaCancelamento(self): return self.AssinaturaCancelamento
    def set_AssinaturaCancelamento(self, AssinaturaCancelamento): self.AssinaturaCancelamento = AssinaturaCancelamento
    def validate_tpAssinaturaCancelamento(self, value):
        # Validate type tpAssinaturaCancelamento, a restriction on xs:base64Binary.
        pass
    def export(self, outfile, level, namespace_='', name_='DetalheType', namespacedef_=''):
        showIndent(outfile, level)
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = []
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='DetalheType')
        if self.hasContent_():
            outfile.write('>\n')
            self.exportChildren(outfile, level + 1, namespace_, name_)
            showIndent(outfile, level)
            ...
            outfile.write('/>\n')
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='DetalheType'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='DetalheType', fromsubclass_=False):
        if self.ChaveNFe is not None:
            self.ChaveNFe.export(outfile, level, namespace_, name_='ChaveNFe', )
        if self.AssinaturaCancelamento is not None:
            showIndent(outfile, level)
            outfile.write('<%sAssinaturaCancelamento>%s</%sAssinaturaCancelamento>\n' % (namespace_, self.gds_format_string(quote_xml(self.AssinaturaCancelamento).encode(ExternalEncoding), input_name='AssinaturaCancelamento'), namespace_))
    def hasContent_(self):
        if (
            self.ChaveNFe is not None or
            ...
            return False
    def exportLiteral(self, outfile, level, name_='DetalheType'):
        level += 1
        self.exportLiteralAttributes(outfile, level, [], name_)
        if self.hasContent_():
            self.exportLiteralChildren(outfile, level, name_)
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.AssinaturaCancelamento is not None:
            showIndent(outfile, level)
            outfile.write('AssinaturaCancelamento=%s,\n' % quote_python(self.AssinaturaCancelamento).encode(ExternalEncoding))
    def build(self, node):
        self.buildAttributes(node, node.attrib, [])
        for child in node:
            nodeName_ = Tag_pattern_.match(child.tag).groups()[-1]
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'ChaveNFe':
            ...
            AssinaturaCancelamento_ = child_.text
            AssinaturaCancelamento_ = self.gds_validate_string(AssinaturaCancelamento_, node, 'AssinaturaCancelamento')
            self.AssinaturaCancelamento = AssinaturaCancelamento_
            self.validate_tpAssinaturaCancelamento(self.AssinaturaCancelamento)    # validate type tpAssinaturaCancelamento
...
def parseString(inString):
    ...
    doc = None
    sys.stdout.write('<?xml version="1.0" ?>\n')
    rootObj.export(sys.stdout, 0, name_="PedidoCancelamentoNFe",
        namespacedef_='')
    return rootObj
...
def parseLiteral(inFileName):
    ...
    # Enable Python to collect the space used by the DOM.
    doc = None
    sys.stdout.write('#from PedidoCancelamentoNFe_v01 import *\n\n')
