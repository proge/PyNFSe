...
class PedidoInformacoesLote(GeneratedsSuper):
    """Schema utilizado para PEDIDO de informações de lote.Este Schema
    XML é utilizado pelos prestadores de serviços para obterem
    informações de lotes de RPS que geraram NF-e."""
    subclass = None
    superclass = None
    ...
    def export(self, outfile, level, namespace_='', name_='PedidoInformacoesLote', namespacedef_=''):
        showIndent(outfile, level)
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = []
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='PedidoInformacoesLote')
        if self.hasContent_():
            outfile.write('>\n')
            ...
            outfile.write('/>\n')
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='PedidoInformacoesLote'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='PedidoInformacoesLote', fromsubclass_=False):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def exportLiteral(self, outfile, level, name_='PedidoInformacoesLote'):
        level += 1
...
class CabecalhoType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, Versao=None, CPFCNPJRemetente=None, NumeroLote=None, InscricaoPrestador=None):
...
def parseString(inString):
    ...
    doc = None
    sys.stdout.write('<?xml version="1.0" ?>\n')
    rootObj.export(sys.stdout, 0, name_="PedidoInformacoesLote",
        namespacedef_='')
    return rootObj
...
def parseLiteral(inFileName):
    ...
    # Enable Python to collect the space used by the DOM.
    doc = None
    sys.stdout.write('#from PedidoInformacoesLote_v01 import *\n\n')
