...
class PedidoConsultaLote(GeneratedsSuper):
    ...
    utilizado pelos prestadores de serviços consultarem as NF-e
    geradas a partir de um lote de RPS."""
    subclass = None
    superclass = None
    ...
    def export(self, outfile, level, namespace_='', name_='PedidoConsultaLote', namespacedef_=''):
        showIndent(outfile, level)
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = []
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='PedidoConsultaLote')
        if self.hasContent_():
            outfile.write('>\n')
            ...
            outfile.write('/>\n')
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='PedidoConsultaLote'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='PedidoConsultaLote', fromsubclass_=False):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def exportLiteral(self, outfile, level, name_='PedidoConsultaLote'):
        level += 1
...
class CabecalhoType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, Versao=None, CPFCNPJRemetente=None, NumeroLote=None):
...
def parseString(inString):
    ...
    doc = None
    sys.stdout.write('<?xml version="1.0" ?>\n')
    rootObj.export(sys.stdout, 0, name_="PedidoConsultaLote",
        namespacedef_='')
    return rootObj
...
def parseLiteral(inFileName):
    ...
    # Enable Python to collect the space used by the DOM.
    doc = None
    sys.stdout.write('#from PedidoConsultaLote_v01 import *\n\n')
