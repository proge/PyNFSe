...
class RetornoConsultaCNPJ(GeneratedsSuper):
    """Schema utilizado para RETORNO de Pedidos de Consultas de CNPJ.Este
    Schema XML é utilizado pelo Web Service para informar aos
    tomadores e/ou prestadores de serviços quais Inscrições
    Municipais (CCM) estão vinculadas a um determinado CNPJ e se
    estes CCM emitem NF-e ou não."""
    subclass = None
    superclass = None
    def __init__(self, Cabecalho=None, Alerta=None, Erro=None, Detalhe=None):
    ...
    def export(self, outfile, level, namespace_='', name_='RetornoConsultaCNPJ', namespacedef_=''):
        showIndent(outfile, level)
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = []
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='RetornoConsultaCNPJ')
        if self.hasContent_():
            outfile.write('>\n')
            ...
            outfile.write('/>\n')
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='RetornoConsultaCNPJ'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='RetornoConsultaCNPJ', fromsubclass_=False):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def exportLiteral(self, outfile, level, name_='RetornoConsultaCNPJ'):
        level += 1
...
class DetalheType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, InscricaoMunicipal=None, EmiteNFe=None):
    ...
    def validate_tpInscricaoMunicipal(self, value):
        # Validate type tpInscricaoMunicipal, a restriction on xs:long.
        pass
    def get_EmiteNFe(self): return self.EmiteNFe
    def set_EmiteNFe(self, EmiteNFe): self.EmiteNFe = EmiteNFe
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='DetalheType', fromsubclass_=False):
        if self.InscricaoMunicipal is not None:
            showIndent(outfile, level)
            outfile.write('<%sInscricaoMunicipal>%s</%sInscricaoMunicipal>\n' % (namespace_, self.gds_format_integer(self.InscricaoMunicipal, input_name='InscricaoMunicipal'), namespace_))
        if self.EmiteNFe is not None:
            showIndent(outfile, level)
            outfile.write('<%sEmiteNFe>%s</%sEmiteNFe>\n' % (namespace_, self.gds_format_boolean(self.gds_str_lower(str(self.EmiteNFe)), input_name='EmiteNFe'), namespace_))
    def hasContent_(self):
        if (
    ...
    def buildAttributes(self, node, attrs, already_processed):
        pass
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'InscricaoMunicipal':
            sval_ = child_.text
            try:
                ival_ = int(sval_)
            except (TypeError, ValueError), exp:
            ...
            self.validate_tpInscricaoMunicipal(self.InscricaoMunicipal)    # validate type tpInscricaoMunicipal
...
def parseString(inString):
    ...
    doc = None
    sys.stdout.write('<?xml version="1.0" ?>\n')
    rootObj.export(sys.stdout, 0, name_="RetornoConsultaCNPJ",
        namespacedef_='')
    return rootObj
...
def parseLiteral(inFileName):
    ...
    # Enable Python to collect the space used by the DOM.
    doc = None
    sys.stdout.write('#from RetornoConsultaCNPJ_v01 import *\n\n')
