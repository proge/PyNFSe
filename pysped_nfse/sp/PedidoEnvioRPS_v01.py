...
class PedidoEnvioRPS(GeneratedsSuper):
    """Schema utilizado para PEDIDO de envio de RPS.Este Schema XML é
    utilizado pelos prestadores de serviços para substituição
    online e individual de RPS por NF-e."""
    subclass = None
    superclass = None
    ...
    def export(self, outfile, level, namespace_='', name_='PedidoEnvioRPS', namespacedef_=''):
        showIndent(outfile, level)
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = []
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='PedidoEnvioRPS')
        if self.hasContent_():
            outfile.write('>\n')
            ...
            outfile.write('/>\n')
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='PedidoEnvioRPS'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='PedidoEnvioRPS', fromsubclass_=False):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def exportLiteral(self, outfile, level, name_='PedidoEnvioRPS'):
        level += 1
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.RPS is not None:
            showIndent(outfile, level)
            outfile.write('RPS=model_.tpRPS(\n')
...
def parseString(inString):
    ...
    doc = None
    sys.stdout.write('<?xml version="1.0" ?>\n')
    rootObj.export(sys.stdout, 0, name_="PedidoEnvioRPS",
        namespacedef_='')
    return rootObj
...
def parseLiteral(inFileName):
    ...
    # Enable Python to collect the space used by the DOM.
    doc = None
    sys.stdout.write('#from PedidoEnvioRPS_v01 import *\n\n')
