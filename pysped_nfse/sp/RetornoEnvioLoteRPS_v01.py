...
class RetornoEnvioLoteRPS(GeneratedsSuper):
    """Schema utilizado para RETORNO de Pedidos de Envio de lote de
    RPS.Este Schema XML é utilizado pelo Web Service para informar
    aos prestadores de serviços o resultado do pedido de envio de
    lote de RPS."""
    subclass = None
    superclass = None
    ...
    def add_ChaveNFeRPS(self, value): self.ChaveNFeRPS.append(value)
    def insert_ChaveNFeRPS(self, index, value): self.ChaveNFeRPS[index] = value
    def export(self, outfile, level, namespace_='', name_='RetornoEnvioLoteRPS', namespacedef_=''):
        showIndent(outfile, level)
        ...
        if self.hasContent_():
            ...
            outfile.write('/>\n')
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='RetornoEnvioLoteRPS'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='RetornoEnvioLoteRPS', fromsubclass_=False):
        ...
        for ChaveNFeRPS_ in self.ChaveNFeRPS:
            ChaveNFeRPS_.export(outfile, level, namespace_, name_='ChaveNFeRPS')
    def hasContent_(self):
        if (
            ...
            return False
    def exportLiteral(self, outfile, level, name_='RetornoEnvioLoteRPS'):
        level += 1
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        outfile.write('],\n')
        showIndent(outfile, level)
        outfile.write('ChaveNFeRPS=[\n')
        level += 1
        for ChaveNFeRPS_ in self.ChaveNFeRPS:
            showIndent(outfile, level)
            outfile.write('model_.tpChaveNFeRPS(\n')
            ChaveNFeRPS_.exportLiteral(outfile, level, name_='tpChaveNFeRPS')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class CabecalhoType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, Versao=None, Sucesso=None, InformacoesLote=None):
    ...
    def validate_tpSucesso(self, value):
        ...
        pass
    def get_InformacoesLote(self): return self.InformacoesLote
    def set_InformacoesLote(self, InformacoesLote): self.InformacoesLote = InformacoesLote
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='CabecalhoType', fromsubclass_=False):
        ...
        if self.InformacoesLote is not None:
            self.InformacoesLote.export(outfile, level, namespace_, name_='InformacoesLote')
    def hasContent_(self):
        if (
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.InformacoesLote is not None:
            showIndent(outfile, level)
            outfile.write('InformacoesLote=model_.tpInformacoesLote(\n')
            self.InformacoesLote.exportLiteral(outfile, level, name_='InformacoesLote')
            showIndent(outfile, level)
            outfile.write('),\n')
    def build(self, node):
        self.buildAttributes(node, node.attrib, [])
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Sucesso':
            ...
            obj_ = tpInformacoesLote.factory()
            obj_.build(child_)
            self.set_InformacoesLote(obj_)
...
def parseString(inString):
    ...
    doc = None
    sys.stdout.write('<?xml version="1.0" ?>\n')
    rootObj.export(sys.stdout, 0, name_="RetornoEnvioLoteRPS",
        namespacedef_='')
    return rootObj
...
def parseLiteral(inFileName):
    ...
    # Enable Python to collect the space used by the DOM.
    doc = None
    sys.stdout.write('#from RetornoEnvioLoteRPS_v01 import *\n\n')
