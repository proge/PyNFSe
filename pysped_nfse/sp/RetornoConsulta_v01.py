...
class RetornoConsulta(GeneratedsSuper):
    """Schema utilizado para RETORNO de pedidos de consulta de NF-e/RPS,
    consultade NF-e recebidas e consulta de lote.Este Schema XML é
    utilizado pelo Web Service para informar aos tomadores e/ou
    prestadores de serviços o resultado de pedidos de consulta de
    NF-e/RPS, consultade NF-e recebidas e consulta de lote."""
    subclass = None
    superclass = None
    def __init__(self, Cabecalho=None, Alerta=None, Erro=None, NFe=None):
    ...
    def insert_NFe(self, index, value): self.NFe[index] = value
    def export(self, outfile, level, namespace_='', name_='RetornoConsulta', namespacedef_=''):
        showIndent(outfile, level)
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = []
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='RetornoConsulta')
        if self.hasContent_():
            outfile.write('>\n')
            ...
            outfile.write('/>\n')
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='RetornoConsulta'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='RetornoConsulta', fromsubclass_=False):
        ...
        for NFe_ in self.NFe:
            NFe_.export(outfile, level, namespace_, name_='NFe')
    def hasContent_(self):
        if (
            ...
            return False
    def exportLiteral(self, outfile, level, name_='RetornoConsulta'):
        level += 1
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        for NFe_ in self.NFe:
            showIndent(outfile, level)
            outfile.write('model_.tpNFe(\n')
            NFe_.exportLiteral(outfile, level, name_='tpNFe')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
def parseString(inString):
    ...
    doc = None
    sys.stdout.write('<?xml version="1.0" ?>\n')
    rootObj.export(sys.stdout, 0, name_="RetornoConsulta",
        namespacedef_='')
    return rootObj
...
def parseLiteral(inFileName):
    ...
    # Enable Python to collect the space used by the DOM.
    doc = None
    sys.stdout.write('#from RetornoConsulta_v01 import *\n\n')
