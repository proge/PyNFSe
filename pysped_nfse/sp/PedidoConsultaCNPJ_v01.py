...
class PedidoConsultaCNPJ(GeneratedsSuper):
    """Schema utilizado para PEDIDO de consultas de CNPJ.Este Schema XML é
    utilizado pelos tomadores e/ou prestadores de serviços
    consultarem quais Inscrições Municipais (CCM) estão
    vinculadas a um determinado CNPJ e se estes CCM emitem NF-e ou
    não."""
    subclass = None
    superclass = None
    def __init__(self, Cabecalho=None, CNPJContribuinte=None, Signature=None):
    ...
    def get_CNPJContribuinte(self): return self.CNPJContribuinte
    def set_CNPJContribuinte(self, CNPJContribuinte): self.CNPJContribuinte = CNPJContribuinte
    def get_Signature(self): return self.Signature
    def set_Signature(self, Signature): self.Signature = Signature
    def export(self, outfile, level, namespace_='', name_='PedidoConsultaCNPJ', namespacedef_=''):
        showIndent(outfile, level)
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = []
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='PedidoConsultaCNPJ')
        if self.hasContent_():
            outfile.write('>\n')
            ...
            outfile.write('/>\n')
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='PedidoConsultaCNPJ'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='PedidoConsultaCNPJ', fromsubclass_=False):
        ...
        if self.CNPJContribuinte is not None:
            self.CNPJContribuinte.export(outfile, level, namespace_, name_='CNPJContribuinte', )
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def exportLiteral(self, outfile, level, name_='PedidoConsultaCNPJ'):
        level += 1
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.CNPJContribuinte is not None:
            showIndent(outfile, level)
            outfile.write('CNPJContribuinte=model_.tpCPFCNPJ(\n')
            self.CNPJContribuinte.exportLiteral(outfile, level, name_='CNPJContribuinte')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Signature is not None:
            showIndent(outfile, level)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Cabecalho':
            ...
            obj_.build(child_)
            self.set_CNPJContribuinte(obj_)
...
def parseString(inString):
    ...
    doc = None
    sys.stdout.write('<?xml version="1.0" ?>\n')
    rootObj.export(sys.stdout, 0, name_="PedidoConsultaCNPJ",
        namespacedef_='')
    return rootObj
...
def parseLiteral(inFileName):
    ...
    # Enable Python to collect the space used by the DOM.
    doc = None
    sys.stdout.write('#from PedidoConsultaCNPJ_v01 import *\n\n')
