...
class PedidoEnvioLoteRPS(GeneratedsSuper):
    """Schema utilizado para PEDIDO de envio de lote de RPS.Este Schema XML
    é utilizado pelos prestadores de serviços para substituição
    em lote de RPS por NF-e."""
    subclass = None
    superclass = None
    def __init__(self, Cabecalho=None, RPS=None, Signature=None):
    ...
    def export(self, outfile, level, namespace_='', name_='PedidoEnvioLoteRPS', namespacedef_=''):
        showIndent(outfile, level)
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = []
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='PedidoEnvioLoteRPS')
        if self.hasContent_():
            outfile.write('>\n')
            ...
            outfile.write('/>\n')
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='PedidoEnvioLoteRPS'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='PedidoEnvioLoteRPS', fromsubclass_=False):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def exportLiteral(self, outfile, level, name_='PedidoEnvioLoteRPS'):
        level += 1
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        for RPS_ in self.RPS:
            showIndent(outfile, level)
            outfile.write('model_.tpRPS(\n')
            RPS_.exportLiteral(outfile, level, name_='tpRPS')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
...
class CabecalhoType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, Versao=None, CPFCNPJRemetente=None, transacao=True, dtInicio=None, dtFim=None, QtdRPS=None, ValorTotalServicos=None, ValorTotalDeducoes=None):
    ...
    def get_QtdRPS(self): return self.QtdRPS
    def set_QtdRPS(self, QtdRPS): self.QtdRPS = QtdRPS
    def validate_tpQuantidade(self, value):
        # Validate type tpQuantidade, a restriction on xs:long.
        pass
    def get_ValorTotalServicos(self): return self.ValorTotalServicos
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='CabecalhoType', fromsubclass_=False):
        ...
        if self.QtdRPS is not None:
            showIndent(outfile, level)
            outfile.write('<%sQtdRPS>%s</%sQtdRPS>\n' % (namespace_, self.gds_format_integer(self.QtdRPS, input_name='QtdRPS'), namespace_))
        if self.ValorTotalServicos is not None:
            showIndent(outfile, level)
            outfile.write('<%sValorTotalServicos>%s</%sValorTotalServicos>\n' % (namespace_, self.gds_format_float(self.ValorTotalServicos, input_name='ValorTotalServicos'), namespace_))
        if self.ValorTotalDeducoes is not None:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'CPFCNPJRemetente':
            ...
            self.QtdRPS = ival_
            self.validate_tpQuantidade(self.QtdRPS)    # validate type tpQuantidade
        elif nodeName_ == 'ValorTotalServicos':
            sval_ = child_.text
            try:
                fval_ = float(sval_)
...
def parseString(inString):
    ...
    doc = None
    sys.stdout.write('<?xml version="1.0" ?>\n')
    rootObj.export(sys.stdout, 0, name_="PedidoEnvioLoteRPS",
        namespacedef_='')
    return rootObj
...
def parseLiteral(inFileName):
    ...
    # Enable Python to collect the space used by the DOM.
    doc = None
    sys.stdout.write('#from PedidoEnvioLoteRPS_v01 import *\n\n')
