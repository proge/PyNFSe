...
class RetornoInformacoesLote(GeneratedsSuper):
    """Schema utilizado para RETORNO de Pedidos de Informações de
    Lote.Este Schema XML é utilizado pelo Web Service para informar
    aos prestadores de serviços o resultado do pedido de
    informações de lote."""
    subclass = None
    superclass = None
    def __init__(self, Cabecalho=None, Alerta=None, Erro=None):
    ...
    def export(self, outfile, level, namespace_='', name_='RetornoInformacoesLote', namespacedef_=''):
        showIndent(outfile, level)
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = []
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='RetornoInformacoesLote')
        if self.hasContent_():
            outfile.write('>\n')
            ...
            outfile.write('/>\n')
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='RetornoInformacoesLote'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='RetornoInformacoesLote', fromsubclass_=False):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def exportLiteral(self, outfile, level, name_='RetornoInformacoesLote'):
        level += 1
...
def parseString(inString):
    ...
    doc = None
    sys.stdout.write('<?xml version="1.0" ?>\n')
    rootObj.export(sys.stdout, 0, name_="RetornoInformacoesLote",
        namespacedef_='')
    return rootObj
...
def parseLiteral(inFileName):
    ...
    # Enable Python to collect the space used by the DOM.
    doc = None
    sys.stdout.write('#from RetornoInformacoesLote_v01 import *\n\n')
