...
class RetornoCancelamentoNFe(GeneratedsSuper):
    """Schema utilizado para RETORNO de Pedidos de cancelamento de
    NF-e.Este Schema XML é utilizado pelo Web Service para informar
    aos prestadores de serviços qual o resultado do pedido de
    ...
    def export(self, outfile, level, namespace_='', name_='RetornoCancelamentoNFe', namespacedef_=''):
        showIndent(outfile, level)
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = []
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='RetornoCancelamentoNFe')
        if self.hasContent_():
            outfile.write('>\n')
            ...
            outfile.write('/>\n')
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='RetornoCancelamentoNFe'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='RetornoCancelamentoNFe', fromsubclass_=False):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def exportLiteral(self, outfile, level, name_='RetornoCancelamentoNFe'):
        level += 1
...
def parseString(inString):
    ...
    doc = None
    sys.stdout.write('<?xml version="1.0" ?>\n')
    rootObj.export(sys.stdout, 0, name_="RetornoCancelamentoNFe",
        namespacedef_='')
    return rootObj
...
def parseLiteral(inFileName):
    ...
    # Enable Python to collect the space used by the DOM.
    doc = None
    sys.stdout.write('#from RetornoCancelamentoNFe_v01 import *\n\n')
