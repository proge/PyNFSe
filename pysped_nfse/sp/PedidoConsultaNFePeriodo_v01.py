...
#
# Generated Fri Dec 28 16:00:26 2012 by generateDS.py version 2.7b.
#
...
class PedidoConsultaNFePeriodo(GeneratedsSuper):
    """Schema utilizado para PEDIDO de consulta de NF-e Emitidas ou
    Recebidas por período.Este Schema XML é utilizado pelos
    Prestadores/Tomadores de serviços consultarem NF-e Emitidas ou
    Recebidas por eles."""
    subclass = None
    superclass = None
    ...
    def export(self, outfile, level, namespace_='', name_='PedidoConsultaNFePeriodo', namespacedef_=''):
        showIndent(outfile, level)
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = []
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='PedidoConsultaNFePeriodo')
        if self.hasContent_():
            outfile.write('>\n')
            ...
            outfile.write('/>\n')
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='PedidoConsultaNFePeriodo'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='PedidoConsultaNFePeriodo', fromsubclass_=False):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def exportLiteral(self, outfile, level, name_='PedidoConsultaNFePeriodo'):
        level += 1
...
class CabecalhoType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, Versao=None, CPFCNPJRemetente=None, CPFCNPJ=None, Inscricao=None, dtInicio=None, dtFim=None, NumeroPagina=1):
    ...
    def get_Inscricao(self): return self.Inscricao
    def set_Inscricao(self, Inscricao): self.Inscricao = Inscricao
    def validate_tpInscricaoMunicipal(self, value):
        # Validate type tpInscricaoMunicipal, a restriction on xs:long.
        pass
    ...
    def get_NumeroPagina(self): return self.NumeroPagina
    def set_NumeroPagina(self, NumeroPagina): self.NumeroPagina = NumeroPagina
    def validate_tpNumero(self, value):
        # Validate type tpNumero, a restriction on xs:long.
        pass
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='CabecalhoType', fromsubclass_=False):
        ...
        if self.Inscricao is not None:
            showIndent(outfile, level)
            outfile.write('<%sInscricao>%s</%sInscricao>\n' % (namespace_, self.gds_format_integer(self.Inscricao, input_name='Inscricao'), namespace_))
        if self.dtInicio is not None:
            showIndent(outfile, level)
            outfile.write('<%sdtInicio>%s</%sdtInicio>\n' % (namespace_, self.gds_format_string(quote_xml(self.dtInicio).encode(ExternalEncoding), input_name='dtInicio'), namespace_))
        if self.dtFim is not None:
            showIndent(outfile, level)
            outfile.write('<%sdtFim>%s</%sdtFim>\n' % (namespace_, self.gds_format_string(quote_xml(self.dtFim).encode(ExternalEncoding), input_name='dtFim'), namespace_))
        if self.NumeroPagina is not None:
            showIndent(outfile, level)
            outfile.write('<%sNumeroPagina>%s</%sNumeroPagina>\n' % (namespace_, self.gds_format_integer(self.NumeroPagina, input_name='NumeroPagina'), namespace_))
    def hasContent_(self):
        if (
            self.CPFCNPJRemetente is not None or
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.CPFCNPJ is not None:
            showIndent(outfile, level)
            outfile.write('CPFCNPJ=model_.tpCPFCNPJ(\n')
            self.CPFCNPJ.exportLiteral(outfile, level, name_='CPFCNPJ')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.Inscricao is not None:
            showIndent(outfile, level)
            outfile.write('Inscricao=%d,\n' % self.Inscricao)
        if self.dtInicio is not None:
            showIndent(outfile, level)
            outfile.write('dtInicio=%s,\n' % quote_python(self.dtInicio).encode(ExternalEncoding))
        if self.dtFim is not None:
            showIndent(outfile, level)
            outfile.write('dtFim=%s,\n' % quote_python(self.dtFim).encode(ExternalEncoding))
        if self.NumeroPagina is not None:
            showIndent(outfile, level)
            outfile.write('NumeroPagina=%d,\n' % self.NumeroPagina)
    def build(self, node):
        self.buildAttributes(node, node.attrib, [])
        for child in node:
            nodeName_ = Tag_pattern_.match(child.tag).groups()[-1]
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'CPFCNPJRemetente':
            ...
            self.validate_tpInscricaoMunicipal(self.Inscricao)    # validate type tpInscricaoMunicipal
        elif nodeName_ == 'dtInicio':
            dtInicio_ = child_.text
            dtInicio_ = self.gds_validate_string(dtInicio_, node, 'dtInicio')
            self.dtInicio = dtInicio_
        elif nodeName_ == 'dtFim':
            dtFim_ = child_.text
            dtFim_ = self.gds_validate_string(dtFim_, node, 'dtFim')
            self.dtFim = dtFim_
        elif nodeName_ == 'NumeroPagina':
            sval_ = child_.text
            try:
                ival_ = int(sval_)
            except (TypeError, ValueError), exp:
            ...
            self.validate_tpNumero(self.NumeroPagina)    # validate type tpNumero
...
def parseString(inString):
    ...
    doc = None
    sys.stdout.write('<?xml version="1.0" ?>\n')
    rootObj.export(sys.stdout, 0, name_="PedidoConsultaNFePeriodo",
        namespacedef_='')
    return rootObj
...
def parseLiteral(inFileName):
    ...
    # Enable Python to collect the space used by the DOM.
    doc = None
    sys.stdout.write('#from PedidoConsultaNFePeriodo_v01 import *\n\n')
