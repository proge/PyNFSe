...
class PedidoConsultaNFe(GeneratedsSuper):
    ...
    utilizado pelos prestadores de serviços consultarem NF-e
    geradas por eles."""
    subclass = None
    superclass = None
    ...
    def export(self, outfile, level, namespace_='', name_='PedidoConsultaNFe', namespacedef_=''):
        showIndent(outfile, level)
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = []
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='PedidoConsultaNFe')
        if self.hasContent_():
            outfile.write('>\n')
            ...
            outfile.write('/>\n')
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='PedidoConsultaNFe'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='PedidoConsultaNFe', fromsubclass_=False):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def exportLiteral(self, outfile, level, name_='PedidoConsultaNFe'):
        level += 1
...
class CabecalhoType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, Versao=None, CPFCNPJRemetente=None):
...
class DetalheType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, ChaveRPS=None, ChaveNFe=None):
        self.ChaveRPS = ChaveRPS
        self.ChaveNFe = ChaveNFe
    def factory(*args_, **kwargs_):
...
def parseString(inString):
    ...
    doc = None
    sys.stdout.write('<?xml version="1.0" ?>\n')
    rootObj.export(sys.stdout, 0, name_="PedidoConsultaNFe",
        namespacedef_='')
    return rootObj
...
def parseLiteral(inFileName):
    ...
    # Enable Python to collect the space used by the DOM.
    doc = None
    sys.stdout.write('#from PedidoConsultaNFe_v01 import *\n\n')
